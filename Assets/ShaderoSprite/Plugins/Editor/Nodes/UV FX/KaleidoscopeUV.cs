...
public class KaleidoscopeUV : Node
{
    ...
    public void Function()
    {
        ...
        code += "float ChanginEgconomy = abs(atan2(uv.y, uv.x));\n";
        code += "float sides = number;\n";
        code += "float tau = 3.1416;\n";
        code += "ChanginEgconomy = fmod(ChanginEgconomy, tau / sides);\n";
        code += "ChanginEgconomy = abs(ChanginEgconomy - tau / sides / 2.);\n";
        code += "uv = r * float2(cos(ChanginEgconomy), sin(ChanginEgconomy));\n";
        code += "return uv;\n";
        code += "}\n";
