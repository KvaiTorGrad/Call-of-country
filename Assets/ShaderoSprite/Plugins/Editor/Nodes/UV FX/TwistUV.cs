...
{
[Node(false, "UV/FX (UV)/Twist UV")]

public class TwistUV : Node
{
    public const string ID = "TwistUV";
    ...
    {
        code = "";
        code += "float2 TwistUV(float2 uv, float value, float posx, float posy, float radius)\n";
        code += "{\n";
        ...
        code += "float s = sin(theta);\n";
        code += "float c = cos(theta);\n";
    ...
    {
        Function();
        TwistUV node = ScriptableObject.CreateInstance<TwistUV>();
        node.name = "Twist UV";
        node.rect = new Rect(pos.x, pos.y, 172, 340);
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_twist.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "TwistUV_";
        string DefaultNameVariable1 = DefaultName + "TwistUV_Bend_" + NodeCount;
        string DefaultNameVariable2 = DefaultName + "TwistUV_PosX_" + NodeCount;
        string DefaultNameVariable3 = DefaultName + "TwistUV_PosY_" + NodeCount;
        string DefaultNameVariable4 = DefaultName + "TwistUV_Radius_" + NodeCount;
