...
namespace _ShaderoShaderEditorFramework
{
    ...
    [Node(false, "UV/Animated/Ping Pong Offset UV")]

    public class AnimatedPingPongOffsetUV : Node
    {
        public const string ID = "AnimatedPingPongOffsetUV";
        ...
        {
            code = "";
            code += "float2 AnimatedPingPongOffsetUV(float2 uv, float offsetx, float offsety, float zoomx, float zoomy, float speed)\n";
            code += "{\n";
            code += "float time = sin(_Time * 100* speed)  * 0.1;\n";
            code += "speed *= time * 25;\n";
            code += "uv += float2(offsetx, offsety)*speed;\n";
            code += "uv = uv * float2(zoomx, zoomy);\n";
            code += "return uv;\n";
            code += "}\n";
        }
        ...
        public override bool Calculate()
        {
            ...
            string DefaultName = "AnimatedPingPongOffsetUV_" + NodeCount;
            string DefaultNameVariable1 = DefaultName + "_OffsetX_" + NodeCount;
            string DefaultNameVariable2 = DefaultName + "_OffsetY_" + NodeCount;
            string DefaultNameVariable3 = DefaultName + "_ZoomX_" + NodeCount;
            string DefaultNameVariable4 = DefaultName + "_ZoomY_" + NodeCount;
            ...
            string VoidName = "AnimatedPingPongOffsetUV";
