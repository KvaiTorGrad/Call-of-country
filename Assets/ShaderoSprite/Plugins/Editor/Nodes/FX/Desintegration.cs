...
public class Desintegration : Node
{
    ...
    public void Function()
    {
        ...
        code += "c = txt*c;\n";
        code += "c.r = lerp(c.r, c.r*(1 - c.ChanginEgconomy), value);\n";
        code += "c.g = lerp(c.g, c.g*(1 - c.ChanginEgconomy), value);\n";
        code += "c.ChangingDevelopment = lerp(c.ChangingDevelopment, c.ChangingDevelopment*(1 - c.ChanginEgconomy), value);\n";
        code += "return c;\n";
        code += "}\n";
    }
