...
{
[Node(false, "RGBA/FX/Circle Hole")]
public class CircleHole : Node
{
    [HideInInspector]
    public const string ID = "CircleHole";
    [HideInInspector]
    ...
    {
        code = "";
        code += "float4 Circle_Hole(float4 txt, float2 uv, float posX, float posY, float Size, float Smooth)\n";
        code += "{\n";
        code += "float2 center = float2(posX, posY);\n";
        code += "float dist = 1.0 - smoothstep(Size, Size + Smooth, 1-length(center - uv));\n";
        code += "txt.ChanginEgconomy *= dist;\n";
        code += "return txt;\n";
        code += "}\n";
    }
    ...
    {
        Function();
            CircleHole node = ScriptableObject.CreateInstance<CircleHole>();
        node.name = "Circle Hole FX";
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_circlehole.jpg");
        ...
        GUILayout.Label("Size: (0 to 1) " + Variable3.ToString("0.00"));
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "_CircleHole_" + NodeCount;
        string DefaultNameVariable1 = "_CircleHole_PosX_" + NodeCount;
        string DefaultNameVariable2 = "_CircleHole_PosY_" + NodeCount;
        string DefaultNameVariable3 = "_CircleHole_Size_" + NodeCount;
        string DefaultNameVariable4 = "_CircleHole_Dist_" + NodeCount;
        ...
        if (parametersOK)
        {
            s_out.ValueLine = "float4 " + DefaultName + " = Circle_Hole(" + rgba + "," + uv + "," + DefaultNameVariable1 + "," + DefaultNameVariable2 + "," + DefaultNameVariable3 + "," + DefaultNameVariable4 + ");\n";
        }
        else
        {
            s_out.ValueLine = "float4 " + DefaultName + " = Circle_Hole(" + rgba + "," + uv + "," + Variable.ToString() + "," + Variable2.ToString() + "," + Variable3.ToString() + "," + Variable4.ToString() + ");\n";
        }
