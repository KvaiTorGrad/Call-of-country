...
namespace _ShaderoShaderEditorFramework
{
    ...
    public class TurnGB : Node
    {
        [HideInInspector]
        public const string ID = "TurnGB";
        [HideInInspector]
        ...
        public void Function()
        {
            ...
            code += "float4 TurnGB(float4 txt, float value)\n";
            code += "{\n";
            ...
            code += "Turn(float3(0.609375, 0.73828125, 0.058593));\n";
            code += "Turn(float3(0.546875, 0.67578125, 0.058593));\n";
            code += "Turn(float3(0.1875, 0.3828125, 0.1875));\n";
            code += "Turn(float3(0.058593, 0.21875, 0.058593));\n";
        ...
        public override Node Create(Vector2 pos)
        {
            ...
            Function();
            TurnGB node = ScriptableObject.CreateInstance<TurnGB>();
            node.name = "Turn Gameboy";
        ...
        {
            Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_turn_gb.jpg");
        ...
        public override bool Calculate()
        {
            ...
            string DefaultName = "TurnGB_" + NodeCount;
            string DefaultNameVariable1 = "_TurnGB_Fade_" + NodeCount;
            string DefaultParameters1 = ", Range(0, 1)) = " + Variable.ToString();
            string VoidName = "TurnGB";
