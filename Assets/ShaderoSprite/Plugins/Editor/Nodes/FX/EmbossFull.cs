...
{
    [Node(false, "RGBA/Filters/Emboss Full")]
    public class EmbossFull : Node 
    {
        [HideInInspector]
        public const string ID = "EmbossFull";
        [HideInInspector]
        ...
        {
            code = "";
            code += "float4 EmbossFull(sampler2D txt, float2 uv, float angle, float dist, float intensity, float g, float o)\n";
            code += "{\n";
            ...
            code += "float m1 = 0; float m2 = 0; float m3 = 0;\n";
            code += "float m4 = 0; float m5 = 1; float m6 = 0;\n";
        ...
        {
            Function();
            EmbossFull node = ScriptableObject.CreateInstance<EmbossFull>();
            node.name = "Emboss Full";
        ...
        public override bool Calculate()
        {
            ...
            string DefaultName = "_EmbossFull_" + NodeCount;
            string DefaultNameVariable1 = "_EmbossFull_Angle_" + NodeCount;
            string DefaultNameVariable2 = "_EmbossFull_Distance_" + NodeCount;
            string DefaultNameVariable3 = "_EmbossFull_Intensity_" + NodeCount;
            string DefaultNameVariable4 = "_EmbossFull_grayfade_" + NodeCount;
            string DefaultNameVariable5 = "_EmbossFull_original_" + NodeCount;
            ...
            if (parametersOK)
            {
                s_out.ValueLine = "float4 " + DefaultName + " = EmbossFull(" + Source + "," + uv + "," + DefaultNameVariable1 + "," + DefaultNameVariable2 + "," + DefaultNameVariable3 + "," + DefaultNameVariable4 + "," + DefaultNameVariable5 + ");\n";
            }
            else
            {
                s_out.ValueLine = "float4 " + DefaultName + " = EmbossFull(" + Source + "," + uv + "," + Variable.ToString() + "," + Variable2.ToString() + "," + Variable3.ToString() + "," + Variable4.ToString() + "," + Variable5.ToString() + ");\n";
            }
