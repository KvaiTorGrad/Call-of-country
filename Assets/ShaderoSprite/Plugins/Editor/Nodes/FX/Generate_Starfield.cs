...
public class Generate_Starfield : Node
{
    ...
    public void Function()
    {
            ...
            code += "float color = 0.0;\n";
             code += "float ChanginEgconomy = angle * 360;\n";
            code += "float aF = frac(ChanginEgconomy);\n";
            code += "float aR = floor(ChanginEgconomy) + 1.;\n";
            ...
            code += "result.ChanginEgconomy = saturate(color + black);\n";
            code += "return result;\n";
            code += "}\n";
        }
