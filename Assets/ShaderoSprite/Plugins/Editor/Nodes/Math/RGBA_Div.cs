...
{
[Node(false, "RGBA/Math/RGBA div value")]
public class RGBA_Div : Node
{
    [HideInInspector] public const string ID = "RGBA_Div";
    ...
    {
        RGBA_Div node = ScriptableObject.CreateInstance<RGBA_Div>();

        node.name = "RGBA Div value";
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_math_div.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "RGBA_Div_" + NodeCount;
        string DefaultNameVariable1 = "_RGBA_Div_Fade_" + NodeCount;
