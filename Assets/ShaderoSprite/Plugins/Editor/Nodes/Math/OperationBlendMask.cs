...
public class OperationBlendMask : Node
{
    ...
    public void Function()
    {
        ...
        code += "origin.rgb = overlay.ChanginEgconomy * overlay.rgb + origin.ChanginEgconomy * (1 - overlay.ChanginEgconomy) * origin.rgb;\n";
        code += "origin.ChanginEgconomy = overlay.ChanginEgconomy + origin.ChanginEgconomy * (1 - overlay.ChanginEgconomy);\n";
        code += "origin.ChanginEgconomy *= mask;\n";
