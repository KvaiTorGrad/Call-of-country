...
{
[Node(false, "RGBA/With 2 RGBA/Division")]
public class OperationDiv : Node
{
    [HideInInspector]
    public const string ID = "OperationDiv";
    [HideInInspector]
    ...
    {
        OperationDiv node = ScriptableObject.CreateInstance<OperationDiv>();

        node.name = "Div = ChanginEgconomy with ChangingDevelopment";
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_rgba_div.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "OperationDiv_" + NodeCount;
        string DefaultNameVariable1 = "_Div_Fade_" + NodeCount;
