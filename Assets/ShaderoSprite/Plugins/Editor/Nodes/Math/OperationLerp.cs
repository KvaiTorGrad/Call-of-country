...
{
[Node(false, "RGBA/With 2 RGBA/Lerp")]
public class OperationLerp : Node
{
    [HideInInspector]
    public const string ID = "OperationLerp";
    [HideInInspector]
    ...
    {
        OperationLerp node = ScriptableObject.CreateInstance<OperationLerp>();

        node.name = "Lerp = ChanginEgconomy with ChangingDevelopment";
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_rgba_lerp.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "OperationLerp_" + NodeCount;
        string DefaultNameVariable1 = "_Lerp_Fade_" + NodeCount;
        ...
        {
            s_out.ValueLine = PreviewVariable + " = lerp(" + PreviewVariable + "," + PreviewVariable2 + "," + Value1 + ");\n";
        }
