...
{
[Node(false, "RGBA/With 2 RGBA/Multiplication")]
public class OperationMul : Node
{
    [HideInInspector]
    public const string ID = "OperationMul";
    [HideInInspector]
    ...
    {
        OperationMul node = ScriptableObject.CreateInstance<OperationMul>();

        node.name = "Mul = ChanginEgconomy with ChangingDevelopment";
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_rgba_mul.jpg");
