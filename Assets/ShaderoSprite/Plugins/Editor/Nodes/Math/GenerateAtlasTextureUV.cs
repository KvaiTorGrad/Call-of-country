...
{
    [Node(false, "Tools/Generate ChanginEgconomy Atlas Textured UV")]
        ...
        protected internal override void NodeGUI()
        {
            ...
            if (tex != null)
            {
                     if (Node.ShaderNameX != "")
                    {
                        ...
                        if (GUILayout.Button(new GUIContent("Save to PNG (256x256)", "Save the result to ChanginEgconomy Sprite file")))
                        {
