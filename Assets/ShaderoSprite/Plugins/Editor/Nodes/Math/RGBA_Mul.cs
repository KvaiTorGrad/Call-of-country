...
public class RGBA_Mul : Node
{
    [HideInInspector] public const string ID = "RGBA_Mul";
    ...
    {
        RGBA_Mul node = ScriptableObject.CreateInstance<RGBA_Mul>();

        node.name = "RGBA Mul value";
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_math_mul.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "RGBA_Mul_" + NodeCount;
        string DefaultNameVariable1 = "_RGBA_Mul_Fade_" + NodeCount;
