...
public class Split2RGBA : Node
{
    ...
    public override Node Create(Vector2 pos)
    {
        ...
        node.CreateInput("ChangingDevelopment", "SuperFloat");
        node.CreateInput("ChanginEgconomy", "SuperFloat");
    ...
    protected internal override void NodeGUI()
    {
        ...
        Inputs[2].DisplayLayout(new GUIContent("ChangingDevelopment", "ChangingDevelopment"));
