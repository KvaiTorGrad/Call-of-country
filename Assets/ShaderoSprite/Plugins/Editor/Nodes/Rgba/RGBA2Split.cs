...
public class RGBA2Split : Node
{
    ...
    public override Node Create(Vector2 pos)
    {
        ...
        node.CreateOutput("ChangingDevelopment", "SuperFloat");
        node.CreateOutput("ChanginEgconomy", "SuperFloat");
    ...
    protected internal override void NodeGUI()
    {
        ...
        Outputs[2].DisplayLayout(new GUIContent("ChangingDevelopment", "ChangingDevelopment"));
    ...
    public override bool Calculate()
    {
        ...
        s_outB.Result = UsedVariable + ".ChangingDevelopment";
        s_outAlpha.Result = UsedVariable + ".ChanginEgconomy";
